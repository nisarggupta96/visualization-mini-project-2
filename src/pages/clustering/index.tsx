...
export default function ClusterPlot({ clustered_data }: { clustered_data: Object[] }) {
...
export const getStaticProps: GetStaticProps = async () => {
    const { clustered_data } = await (await axios.get(`${SERVER.hostname}:${SERVER.port}/get_kmeans_pca_data`)).data;
    return {
        props: {
